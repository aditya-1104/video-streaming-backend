console.log(">>> loaded user.controller.js");
...
const loginUser = asyncHandler( async(req,res) => {
    ...
    if (!isPasswordValid) {
        throw new ApiError(401,"Login Credentials don't match");
    }
...
const updateUserAvatar = asyncHandler(async(req, res) => {
    ...
    await deleteOnCloudinary(oldUserAvatar);
...
const updateUserCoverImage = asyncHandler(async(req, res) => {
    ...
    if (oldUserCoverImage) {
        await deleteOnCloudinary(oldUserCoverImage);
    }
